...
You may need to raise an issue/email about this, you will need to provide the 'messages.txt' file which can be generated by doing:

1. Plug in a USB keyboard
2. Press `F4` (to quite emulationstation)
